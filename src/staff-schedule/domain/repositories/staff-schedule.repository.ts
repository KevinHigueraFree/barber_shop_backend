import type { NewStaffSchedule } from '@/staff-schedule/domain/entities/new-staff-schedule';
import type { UpdateStaffSchedule } from '@/staff-schedule/domain/entities/update-staff-schedule';
