import type { NewAppointmentStatus } from '@/modules/appointment-status/domain/entities/new-appointment-status';
import type { UpdateAppointmentStatus } from '@/modules/appointment-status/domain/entities/update-appointment-status';
