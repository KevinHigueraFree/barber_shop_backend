import type { NewTimeOff } from '@/modules/time-off/domain/entities/new-time-off';
import type { UpdateTimeOff } from '@/modules/time-off/domain/entities/update-time-off';
