...
import { NewTimeSlot } from '@/modules/time-slot/domain/entities/new-time-slot';
...
import { TimeSlotRepository } from '@/modules/time-slot/domain/repositories/time-slot.repository';
