import type { NewSchedulingSetting } from '@/modules/scheduling-setting/domain/entities/new-scheduling-setting';
import type { UpdateSchedulingSetting } from '@/modules/scheduling-setting/domain/entities/update-scheduling-setting';
